...
>
	...
	>
		...
		{#if windowWidth < 1200}
			{#if titleLength >= 42}
				<h2 class="name" style:font-size="normal">{game.name}</h2>
			{:else if titleLength < 42}
				<h2 class="name" style:font-size="1.5rem">{game.name}</h2>
			{/if}
		{:else if windowWidth >= 1200}
			{#if titleLength >= 42}
				<h2 class="name" style:font-size="1.5rem">{game.name}</h2>
			{:else if titleLength < 42}
				<h2 class="name" style:font-size="2.5rem">{game.name}</h2>
			{/if}
		{/if}
