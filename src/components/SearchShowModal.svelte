...
>
	...
	>
		...
		{#if windowWidth < 1200}
			{#if titleLength >= 42}
				<h2 class="name" style:font-size="normal">{show.name}</h2>
			{:else if titleLength < 42}
				<h2 class="name" style:font-size="1.5rem">{show.name}</h2>
			{/if}
		{:else if windowWidth >= 1200}
			{#if titleLength >= 42}
				<h2 class="name" style:font-size="1.5rem">{show.name}</h2>
			{:else if titleLength < 42}
				<h2 class="name" style:font-size="2.5rem">{show.name}</h2>
			{/if}
		{/if}
		<div class="position-change">
			<div class="information">
				...
				{:else if titleLength < 42}
					<h3 class="desc">{show.overview}</h3>
				{/if}
			</div>
